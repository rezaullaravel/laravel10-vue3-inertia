                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4>Product List
                                    <Link href="/product/create" class="btn btn-info" style="float: right;">Add Product</Link>
                                </h4>
                            </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                         <tr v-for="(product,index) in products.data" :key="product.id" class="text-center">
                                           ...
                                           <td>
                                            <Link :href="`/view/product/${product.id}`" class="btn btn-primary btn-sm m-2">View</Link>
                                             <Link :href="`/edit/product/${product.id}`" class="btn btn-info btn-sm">Edit</Link>
